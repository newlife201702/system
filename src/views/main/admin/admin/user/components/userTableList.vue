  ...
  <div class="tableListContainer">
    <el-table :data="list" style="width: 100%" border
      ...
      <el-table-column label="操作" width="350" align="center">
        <template #default="scope">
          <el-button size="small" @click="handleRoles(scope.$index, scope.row)">分配角色</el-button>
...
const handleRoles= (index: number, row: ReqUserRowData) =>{
  emit('openRolesDialog',row)
}
...
const handleDelete = (index: number, row: ReqUserRowData) => {
  ElMessageBox.confirm(
    '请确认要删除该用户?',
    '提示',
    {
